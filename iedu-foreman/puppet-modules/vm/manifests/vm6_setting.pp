class vm::vm6_setting (String $status="present", String $vm_name, String $network, String $macaddr, String $bridgeadapter, String $usbmode, Boolean $accelerate2dvideo, Boolean $accelerate3d, String $monitorcount, Boolean $readonly) {
